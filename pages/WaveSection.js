...
const techStack = [
  ...
  { IconComponent: SiKafka, name: "Kafka", color: "#231F20", delay: 0.5 },
  { IconComponent: SiMongodb, name: "MongoDB", color: "#47A248", delay: 0.6 },
  {
  ...
  { IconComponent: FaAws, name: "AWS", color: "#FF9900", delay: 0.8 },
  { IconComponent: FaDocker, name: "Docker", color: "#2496ED", delay: 0.9 },
  {
